...
module.exports.cfConfigurations = [
  ...
  },
  {
    ...
    dimensions: [
      ...
      { name: "coroner_area", type: "stringConvert", functiontype: "dataMatches", tableCol: "coroner_area", function: convertValueOrUnknown },
      { name: "csp_distict", type: "stringConvert", functiontype: "dataMatches", tableCol: "csp_distict", function: convertValueOrUnknown },
      ...
      { name: "reported_by", type: "stringConvert", functiontype: "dataMatches", tableCol: "reported_by", function: convertValueOrUnknown },
      ...
      { name: "occupation", type: "stringConvert", functiontype: "dataMatches", tableCol: "occupation", function: convertValueOrUnknown },
      { name: "type_of_job", type: "stringConvert", functiontype: "dataMatches", tableCol: "type_of_job", function: convertValueOrUnknown },
      { name: "employment", type: "stringConvert", functiontype: "dataMatches", tableCol: "employment", function: convertValueOrUnknown },
      { name: "imd_decile", type: "stringConvert", functiontype: "dataMatches", tableCol: "imd_decile", function: convertValueOrUnknown },
      { name: "bereavement_offered", type: "stringConvert", functiontype: "dataMatches", tableCol: "bereavement_offered", function: convertValueOrUnknown },
      { name: "inquest_conclusion", type: "stringConvert", functiontype: "dataMatches", tableCol: "inquest_conclusion", function: convertValueOrUnknown },
      ...
      { name: "rts_accurate", type: "stringConvert", functiontype: "dataMatches", tableCol: "rts_accurate", function: convertValueOrUnknown },
      { name: "medication", type: "arraySimple", functiontype: "filterContains", tableCol: "medication" },
      { name: "age_group", type: "stringConvert", functiontype: "dataMatches", tableCol: "age_group", function: convertValueOrUnknown },
      { name: "asc_lcc_update", type: "stringConvert", functiontype: "dataMatches", tableCol: "asc_lcc_update", function: convertValueOrUnknown },
      { name: "cgl_update", type: "stringConvert", functiontype: "dataMatches", tableCol: "cgl_update", function: convertValueOrUnknown },
      { name: "csp_resident", type: "stringConvert", functiontype: "dataMatches", tableCol: "csp_resident", function: convertValueOrUnknown },
      { name: "da", type: "stringConvert", functiontype: "dataMatches", tableCol: "da", function: convertValueOrUnknown },
      { name: "delphi_update", type: "stringConvert", functiontype: "dataMatches", tableCol: "delphi_update", function: convertValueOrUnknown },
      { name: "drd_s", type: "stringConvert", functiontype: "dataMatches", tableCol: "drd_s", function: convertValueOrUnknown },
      { name: "ethnicity", type: "stringConvert", functiontype: "dataMatches", tableCol: "ethnicity", function: convertValueOrUnknown },
      { name: "registered_gp_practise", type: "stringConvert", functiontype: "dataMatches", tableCol: "registered_gp_practise", function: convertValueOrUnknown },
      { name: "location_postcode_mosaic", type: "stringConvert", functiontype: "dataMatches", tableCol: "location_postcode_mosaic", function: convertMosType },
      { name: "postcode_mosaic", type: "stringConvert", functiontype: "dataMatches", tableCol: "postcode_mosaic", function: convertMosType },
    ],
  },
];
